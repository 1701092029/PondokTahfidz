...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="" method="post" class="form-inline text-gray-800">
            ...
            <select name="id_pengajar" id="id_pengajar" class="form-control mb-3">
                <option value="">- PILIH -</option>
                <?php
                foreach ($list_nampeng as $p) {
                    if ($nmpeng == $p['id_pengajar']) {
                ?>
                        <option selected value="<?php echo $p['id_pengajar'];  ?>"><?php echo $p['nama_pengajar']; ?></option>
                    <?php
                    } else {
                    ?>
            ...
            <?php } else { ?>
                &nbsp;<a target="_blank" href="<?= base_url(); ?>PrintPresent/PrintPerorang/<?php echo $thn  ?>/<?php echo $blnnya  ?>/<?php echo $nmpeng  ?>" class="btn btn-danger mb-3"><i class="fa fa-print"></i> Cetak</a>
            <?php } ?>
        </form>
        ...
        <div class="table-responsive mt-3">
            <table class="table table-hover text-gray-800" id="" width="100%" cellspacing="0">
                <thead class="border-5">
                    ...
                    <tr>
                        <th valign="center">#</th>
                        <th valign="center">id_absen</th>
                        <th valign="center">Nama Pengajar</th>
                        <th valign="center">Tanggal</th>
                        <th valign="center">Status Kehadiran</th>
